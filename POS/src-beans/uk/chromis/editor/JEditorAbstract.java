...
public abstract class JEditorAbstract extends javax.swing.JPanel implements EditorComponent {
    ...
    private final Border m_borderactive =  new javax.swing.border.CompoundBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4)));
    private final Border m_borderinactive =  new javax.swing.border.CompoundBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("TextField.selectionBackground")), new javax.swing.border.EmptyBorder(new java.awt.Insets(1, 4, 1, 4)));
    ...
    private void setActive(boolean bValue) {
        ...
        if(m_bActive){
            Font f = m_jText.getFont();
            m_jText.setFont(new Font(f.getName(), Font.BOLD, 18));
        }
        else
        {
            Font f = m_jText.getFont();
            m_jText.setFont(new Font(f.getName(), Font.PLAIN , 12));
        }
    ...
    private void initComponents() {
        ...
        panBackground.setPreferredSize(null);
        ...
        m_jText.setMaximumSize(null);
        m_jText.setMinimumSize(null);
