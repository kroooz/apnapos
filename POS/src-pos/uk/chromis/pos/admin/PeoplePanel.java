    ...
    protected void init() {
        ...
        SentenceExec deletesent = new SentenceExecTransaction(app.getSession()) {
            ...
            public int execInTransaction(Object params) throws BasicException {
                ...
                String currentUserId = app.getAppUserView().getUser().getId();
                
                if(((String)values[0]).equalsIgnoreCase(currentUserId)){
        ...
        if(this.dlSync.isTillBranchSyncEnabled()){
            spr = new SaveProvider(null, null, null);
        }
