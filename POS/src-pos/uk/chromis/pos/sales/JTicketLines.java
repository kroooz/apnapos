...
public class JTicketLines extends javax.swing.JPanel {
    ...
    public void refresh()
    {
        m_jTableModel.fireTableDataChanged();
    }
    ...
    public void selectLastRow(){
        int rowsCount = m_jTableModel.getRowCount();
    ...
    public void setSelectedIndex(int i) {
        ...
        // Seleccionamos
        int count = m_jTicketTable.getRowCount();
    ...
    private class TicketCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if(row == JPanelTicket.lastMergedRowIndex){
                aux.setForeground(Color.MAGENTA);
            }
            else
            {
    ...
    private class TicketTableModel extends AbstractTableModel {
        ...
        public String getColumnNameWithoutLocal(int column)
        {
    ...
    public javax.swing.JScrollPane m_jScrollTableTicket;
