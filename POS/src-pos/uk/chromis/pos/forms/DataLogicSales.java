...
public class DataLogicSales extends BeanFactoryDataSingle {
    ...
    private SentenceFind m_productStockCurrent;
    ...
    public void init(Session s) {
        ...
        m_productStockCurrent = new StaticSentence(s, "SELECT UNITS FROM STOCKCURRENT WHERE PRODUCT = ? AND SITEGUID = ? ",
                SerializerWriteString.INSTANCE, SerializerReadString.INSTANCE);
    ...
    public final SentenceList getProductList(String siteGuid) {
        ...
        return new StaticSentence(s, new QBFBuilder(
                ...
                + "ORDER BY P.REFERENCE, P.NAME LIMIT 10",
    ...
    public final Double getProductStockCurrent(String ProductID, String LocationGUID) throws BasicException {
        
        Double stockCurrent = (double)0;
        
        try
        {
            stockCurrent = (Double) m_productStockCurrent.find(ProductID, LocationGUID);
        }
        catch(Exception ex)
        {
        }
