...
// to look at
    ...
    private Component getScriptMenu(String menutext) throws ScriptException {
        ...
        if(StartPOS.resoucesPaneEnabled == false){
            menutext = menutext.replace("submenu.addPanel(\"/uk/chromis/images/resources.png\", \"Menu.Resources\", \"uk.chromis.pos.admin.ResourcesPanel\");", "");
        }
