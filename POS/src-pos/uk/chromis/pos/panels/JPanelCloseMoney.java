...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    Double actualCard;
    Double keepCash;
    Double cashExcessShortage;
    Double cardExcessShortage;
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        addTextChangeListener(jTextOpeningCash);
        addTextChangeListener(jTextActualCash);
        addTextChangeListener(jTextActualCard);
        addTextChangeListener(jTextKeepCashInDrawer);
    }
    ...
    private void loadData() throws BasicException {
        ...
        jTextOpeningCash.setText(m_PaymentsToClose.printOpeningCash());
...
// read number of no cash drawer activations
    ...
    private void calculateExcessShortage() {
        ...
        List<PaymentsModel.PaymentsLine> paymentLines = m_PaymentsToClose.getPaymentLines();
        
        systemCash = (double)0;
        Double systemCard = (double)0;
        ...
        String actualCashString = jTextActualCash.getText().isEmpty() ? "0" : jTextActualCash.getText();
        String openingCashString = jTextOpeningCash.getText().isEmpty() ? "0" : jTextOpeningCash.getText();
        String actualCardString = jTextActualCard.getText().isEmpty() ? "0" : jTextActualCard.getText();
        String keepCashString = jTextKeepCashInDrawer.getText().isEmpty() ? "0" : jTextKeepCashInDrawer.getText();
        actualCash = Double.parseDouble( actualCashString );
        openingCash = Double.parseDouble( openingCashString );
        actualCard = Double.parseDouble( actualCardString );
        keepCash = Double.parseDouble( keepCashString );
        
        cashExcessShortage = actualCash - systemCash - openingCash;
        cardExcessShortage = actualCard - systemCard;
        
        jLabelCashExcessShortage.setText(Formats.DOUBLE.formatValue(cashExcessShortage));
        jLabelCardExcessShortage.setText(Formats.DOUBLE.formatValue(cardExcessShortage));
    }
    ...
    private void printPayments(String report) {
        ...
        if (sresource == null) {
            ...
            try {
                ...
                script.put("systemcash", Double.toString(this.systemCash));
                script.put("openingcash", Double.toString(this.openingCash));
                script.put("openingplussystemcash", Double.toString(this.openingCash + this.systemCash));
                script.put("actualcash", Double.toString(this.actualCash));
                script.put("cashexcessshortage", Double.toString(this.cashExcessShortage));
                script.put("actualcard", Double.toString(this.actualCard));
                script.put("cardexcessshortage", Double.toString(this.cardExcessShortage));
    ...
    private void addTextChangeListener(JTextField jTextField) {
    ...
    private void resetFields() {
        ...
        jTextOpeningCash.setText(jTextKeepCashInDrawer.getText());
        jTextKeepCashInDrawer.setText(null);
        jTextActualCash.setText(null);
        jTextActualCard.setText(null);
    }
    ...
    private void initComponents() {
        ...
        jPanelActualAmounts = new javax.swing.JPanel();
        jLabel18 = new javax.swing.JLabel();
        jTextOpeningCash = new javax.swing.JTextField();
        jLabel19 = new javax.swing.JLabel();
        jLabel20 = new javax.swing.JLabel();
        jLabel9 = new javax.swing.JLabel();
        jTextActualCash = new javax.swing.JTextField();
        jLabel10 = new javax.swing.JLabel();
        jLabelCashExcessShortage = new javax.swing.JLabel();
        jLabel13 = new javax.swing.JLabel();
        jTextActualCard = new javax.swing.JTextField();
        jLabel14 = new javax.swing.JLabel();
        jLabelCardExcessShortage = new javax.swing.JLabel();
        jPanel2 = new javax.swing.JPanel();
        jLabel17 = new javax.swing.JLabel();
        jTextKeepCashInDrawer = new javax.swing.JTextField();
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(m_jSales, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(m_jSalesSubtotal, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(m_jSalesSubtotal, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel12, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(m_jSalesTaxes, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(m_jSalesTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(m_jCash, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jNoCashSales, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanelActualAmounts.setLayout(new java.awt.GridLayout(0, 4, 2, 2));

        jLabel18.setText("Opening Cash");
        jPanelActualAmounts.add(jLabel18);
        jPanelActualAmounts.add(jTextOpeningCash);

        jLabel19.setText("Opening Cash + System Cash");
        jPanelActualAmounts.add(jLabel19);

        jLabel20.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanelActualAmounts.add(jLabel20);

        jLabel9.setText("Actual Cash Amount");
        jPanelActualAmounts.add(jLabel9);
        jPanelActualAmounts.add(jTextActualCash);

        jLabel10.setText("Cash Excess / (Shortage)");
        jPanelActualAmounts.add(jLabel10);

        jLabelCashExcessShortage.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanelActualAmounts.add(jLabelCashExcessShortage);

        jLabel13.setText("Actual Card Amount");
        jPanelActualAmounts.add(jLabel13);
        jPanelActualAmounts.add(jTextActualCard);

        jLabel14.setText("Card Excess / (Shortage)");
        jPanelActualAmounts.add(jLabel14);

        jLabelCardExcessShortage.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanelActualAmounts.add(jLabelCardExcessShortage);

        jPanel2.setBorder(null);
        jPanel2.setLayout(new java.awt.GridLayout(1, 0));

        jLabel17.setText("Keep cash in Drawer");
        jPanel2.add(jLabel17);

        jTextKeepCashInDrawer.setMinimumSize(new java.awt.Dimension(500, 28));
        jTextKeepCashInDrawer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextKeepCashInDrawerKeyTyped(evt);
            }
        });
        jPanel2.add(jTextKeepCashInDrawer);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanelActualAmounts, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanelActualAmounts, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                m_dlSystem.execInsertCash(
                        new Object[]{m_App.getActiveCashIndex(), m_App.getProperties().getHost(), m_App.getActiveCashSequence(), m_App.getActiveCashDateStart(), m_App.getActiveCashDateEnd(), keepCash});
    ...
    private void jTextKeepCashInDrawerKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextKeepCashInDrawerKeyTyped
        allowDecimalOnly(jTextKeepCashInDrawer, evt);
    }//GEN-LAST:event_jTextKeepCashInDrawerKeyTyped

    private void allowDecimalOnly(JTextField txt, java.awt.event.KeyEvent evt){
        char vchar = evt.getKeyChar();
        String initalText = txt.getText();
        String finalText = initalText + vchar;
        
        try
        {
            Double amount = Double.parseDouble(finalText);
        }
        catch(Exception ex)
        {
            evt.consume();
    ...
    private javax.swing.JLabel jLabelCardExcessShortage;
    private javax.swing.JLabel jLabelCashExcessShortage;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JPanel jPanel4;
    private javax.swing.JPanel jPanel5;
    private javax.swing.JPanel jPanelActualAmounts;
    private javax.swing.JPanel jPanelBottom;
    private javax.swing.JPanel jPanelTop;
    private javax.swing.JSeparator jSeparator1;
    private javax.swing.JTextField jTextActualCard;
    private javax.swing.JTextField jTextActualCash;
    private javax.swing.JTextField jTextKeepCashInDrawer;
    private javax.swing.JTextField jTextOpeningCash;
